...
var SportsLib = /** @class */ (function () {
     ...
     */
    SportsLib.importFromGPX = function (gpxString, domParser) {
     ...
     * @param xmlDocument
     */
    SportsLib.importFromTCX = function (xmlDocument) {
     ...
     * @param arrayBuffer
     */
    SportsLib.importFromFit = function (arrayBuffer) {
     ...
     * @param jsonString
     */
    SportsLib.importFromSuunto = function (jsonString) {
     ...
     */
    SportsLib.importFromJSON = function (json) {
