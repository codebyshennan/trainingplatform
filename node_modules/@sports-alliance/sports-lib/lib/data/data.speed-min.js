...
var DataSpeedMinKnots = /** @class */ (function (_super) {
    __extends(DataSpeedMinKnots, _super);
    function DataSpeedMinKnots() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataSpeedMinKnots.prototype.getDisplayType = function () {
        return _super.prototype.getDisplayType.call(this);
    };
    DataSpeedMinKnots.type = 'Minimum speed in knot';
    DataSpeedMinKnots.displayType = DataSpeedMin.type;
    return DataSpeedMinKnots;
