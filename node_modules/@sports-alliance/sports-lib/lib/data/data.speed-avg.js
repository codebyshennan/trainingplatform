...
var DataSpeedAvgKnots = /** @class */ (function (_super) {
    __extends(DataSpeedAvgKnots, _super);
    function DataSpeedAvgKnots() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataSpeedAvgKnots.prototype.getDisplayType = function () {
        return _super.prototype.getDisplayType.call(this);
    };
    DataSpeedAvgKnots.type = 'Average speed in knots';
    DataSpeedAvgKnots.displayType = DataSpeedAvg.type;
    return DataSpeedAvgKnots;
