...
var DataSpeedMaxKnots = /** @class */ (function (_super) {
    __extends(DataSpeedMaxKnots, _super);
    function DataSpeedMaxKnots() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataSpeedMaxKnots.prototype.getDisplayType = function () {
        return _super.prototype.getDisplayType.call(this);
    };
    DataSpeedMaxKnots.type = 'Maximum speed in knots';
    DataSpeedMaxKnots.displayType = DataSpeedMax.type;
    return DataSpeedMaxKnots;
}(data_speed_1.DataSpeedKnots));
