...
var DataSpeedKnots = /** @class */ (function (_super) {
    __extends(DataSpeedKnots, _super);
    function DataSpeedKnots() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataSpeedKnots.prototype.getDisplayType = function () {
        return _super.prototype.getDisplayType.call(this);
    };
    DataSpeedKnots.type = 'Speed in knots';
    DataSpeedKnots.displayType = DataSpeed.type;
    DataSpeedKnots.unit = 'kn';
    return DataSpeedKnots;
}(DataSpeed));
